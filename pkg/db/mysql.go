...
func NewDefaultMysqlConn() *MySQL {
	return NewMySQLFromDSN("root:888888@tcp(mysql:3306)/coss?allowNativePasswords=true&timeout=800ms&readTimeout=200ms&writeTimeout=800ms&parseTime=true&loc=Local&charset=utf8,utf8mb4")
}

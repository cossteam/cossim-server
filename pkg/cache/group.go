...
//	GetGroup(ctx context.Context, groupID uint32) (*groupgrpcv1.Group, error)
//	GetGroups(ctx context.Context, groupID []uint32) ([]*groupgrpcv1.Group, error)
...
//}
//
//func (g *GroupCacheRedis) SetGroup(ctx context.Context, groups ...*groupgrpcv1.Group) error {
//	if len(groups) == 0 {
...
//}
//
//func (g *GroupCacheRedis) GetGroup(ctx context.Context, groupID uint32) (*groupgrpcv1.Group, error) {
...
//}
//
//func (g *GroupCacheRedis) GetGroups(ctx context.Context, groupIDs []uint32) ([]*groupgrpcv1.Group, error) {
//	if len(groupIDs) == 0 {
...
//	}
//
//	groups := make([]*groupgrpcv1.Group, 0, len(groupIDs))

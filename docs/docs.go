...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/interfaces.CreateRoomRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/interfaces.JoinRoomRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "成功加入通话",
                        "schema": {
                            "$ref": "#/definitions/interfaces.JoinRoomResponse"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_cossim_coss-server_internal_msg_api_http_model.Response"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_cossim_coss-server_internal_msg_api_http_model.SendGroupMsgRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_cossim_coss-server_internal_msg_api_http_model.LabelMsgType": {
            "type": "integer",
            "enum": [
                0,
                1
        ...
        "github_com_cossim_coss-server_internal_msg_api_http_model.Response": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "github_com_cossim_coss-server_internal_msg_api_http_model.SendGroupMsgRequest": {
            "type": "object",
            "required": [
                "content",
                "dialog_id",
            ...
            "properties": {
                ...
                "type": {
                    "$ref": "#/definitions/github_com_cossim_coss-server_internal_msg_api_http_model.UserMessageType"
                }
            }
        },
        "github_com_cossim_coss-server_internal_msg_api_http_model.UserMessageType": {
            "type": "integer",
            "enum": [
                1,
                2,
        ...
        "interfaces.JoinRoomResponse": {
            "type": "object",
            "properties": {
                "token": {
                    "description": "Token 加入通话的token",
                    "type": "string"
                },
                "url": {
                    "description": "Url webRtc服务器地址",
        ...
        "interfaces.ParticipantInfo": {
            "type": "object",
            "properties": {
                "identity": {
                    "description": "Identity User nickname",
                    "type": "string"
                },
                "is_publisher": {
                    "description": "IsPublisher Whether the participant is the creator",
                    "type": "boolean"
                },
                "joined_at": {
                    "description": "JoinedAt Join time",
                    "type": "integer"
                },
                "name": {
                    "type": "string"
        ...
        "interfaces.Room": {
            ...
            "properties": {
                ...
                "participant": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/interfaces.ParticipantInfo"
                    }
                },
                "room": {
                    "type": "string"
        ...
        "interfaces.RoomOption": {
            "type": "object",
            "properties": {
                "audio_enabled": {
                    "description": "AudioEnabled Whether to enable audio",
                    "type": "boolean"
                },
                "codec": {
                ...
                "frame_rate": {
                    "description": "FrameRate Frame rate",
                    "type": "integer"
                },
                "resolution": {
                ...
                "video_enabled": {
                    "description": "VideoEnabled Whether to enable video",
                    "type": "boolean"
                }
            }
        },
        ...
        "model.LabelGroupMessageRequest": {
            ...
            "properties": {
                "is_label": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_cossim_coss-server_internal_msg_api_http_model.LabelMsgType"
                        }
                    ]
                },
                "msg_id": {

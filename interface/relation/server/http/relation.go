...
// @Summary 好友申请列表
// @Description 好友申请列表 UserStatus 申请状态 (0=申请中, 1=待通过, 2=已添加, 3=被拒绝)
// @Produce  json
// @Success		200 {object} model.Response{data=[]model.UserRequestListResponse} "UserStatus 申请状态 (0=申请中, 1=待通过, 2=已添加, 3=被拒绝)"

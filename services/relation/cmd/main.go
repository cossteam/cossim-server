...
import (
	...
	"github.com/cossim/coss-server/services/relation/config"
	"github.com/cossim/coss-server/services/relation/interfaces"
...
func main() {
	...
	api.RegisterRelationServiceServer(grpcServer, handler)

...
import (
	"flag"
	"github.com/cossim/coss-server/internal/storage/interfaces/grpc"
	"github.com/cossim/coss-server/internal/storage/interfaces/http"
...
var (
	...
	hotReload         bool
	configKey         string
	configKeys        string = strings.Join([]string{discovery.CommonMySQLConfigKey, discovery.CommonOssConfigKey, discovery.CommonRedisConfigKey}, ",")
)
...
func init() {
	...
	flag.StringVar(&configKey, "config-key", "service/storage", "Service configuration path in the configuration center")

...
var file_api_v1_dialog_proto_rawDesc = []byte{
	...
	0x44, 0x49, 0x41, 0x4c, 0x4f, 0x47, 0x10, 0x01, 0x32, 0xa5, 0x0e, 0x0a, 0x0d, 0x44, 0x69, 0x61,
...
var file_api_v1_dialog_proto_depIdxs = []int32{
	...
	16, // 20: v1.DialogService.DeleteDialogUsersByDialogID:input_type -> v1.DeleteDialogUsersByDialogIDRequest
	20, // 21: v1.DialogService.DeleteDialogUserByDialogIDAndUserID:input_type -> v1.DeleteDialogUserByDialogIDAndUserIDRequest
	20, // 22: v1.DialogService.DeleteDialogUserByDialogIDAndUserIDRevert:input_type -> v1.DeleteDialogUserByDialogIDAndUserIDRequest
	2,  // 23: v1.DialogService.CreateDialog:output_type -> v1.CreateDialogResponse
	31, // 24: v1.DialogService.CreateAndJoinDialogWithGroup:output_type -> v1.CreateAndJoinDialogWithGroupResponse
	31, // 25: v1.DialogService.CreateAndJoinDialogWithGroupRevert:output_type -> v1.CreateAndJoinDialogWithGroupResponse
	27, // 26: v1.DialogService.ConfirmFriendAndJoinDialog:output_type -> v1.ConfirmFriendAndJoinDialogResponse
	29, // 27: v1.DialogService.ConfirmFriendAndJoinDialogRevert:output_type -> v1.ConfirmFriendAndJoinDialogRevertResponse
	4,  // 28: v1.DialogService.JoinDialog:output_type -> v1.JoinDialogResponse
	4,  // 29: v1.DialogService.JoinDialogRevert:output_type -> v1.JoinDialogResponse
	6,  // 30: v1.DialogService.GetUserDialogList:output_type -> v1.GetUserDialogListResponse
	8,  // 31: v1.DialogService.GetDialogByIds:output_type -> v1.GetDialogByIdsResponse
	11, // 32: v1.DialogService.GetDialogUsersByDialogID:output_type -> v1.GetDialogUsersByDialogIDResponse
	19, // 33: v1.DialogService.GetDialogUserByDialogIDAndUserID:output_type -> v1.GetDialogUserByDialogIDAndUserIdResponse
	23, // 34: v1.DialogService.GetDialogByGroupId:output_type -> v1.GetDialogByGroupIdResponse
	25, // 35: v1.DialogService.GetDialogByGroupIds:output_type -> v1.GetDialogByGroupIdsResponse
	13, // 36: v1.DialogService.DeleteDialogByIds:output_type -> v1.DeleteDialogByIdsResponse
	15, // 37: v1.DialogService.DeleteDialogById:output_type -> v1.DeleteDialogByIdResponse
	17, // 38: v1.DialogService.DeleteDialogUsersByDialogID:output_type -> v1.DeleteDialogUsersByDialogIDResponse
	21, // 39: v1.DialogService.DeleteDialogUserByDialogIDAndUserID:output_type -> v1.DeleteDialogUserByDialogIDAndUserIDResponse
	21, // 40: v1.DialogService.DeleteDialogUserByDialogIDAndUserIDRevert:output_type -> v1.DeleteDialogUserByDialogIDAndUserIDResponse

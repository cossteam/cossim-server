...
func (s *Service) CreateGroupAnnouncement(ctx context.Context, in *relationgrpcv1.CreateGroupAnnouncementRequest) (*relationgrpcv1.CreateGroupAnnouncementResponse, error) {
...
func (s *Service) GetGroupAnnouncementList(ctx context.Context, in *relationgrpcv1.GetGroupAnnouncementListRequest) (*relationgrpcv1.GetGroupAnnouncementListResponse, error) {
...
func (s *Service) GetGroupAnnouncement(ctx context.Context, in *relationgrpcv1.GetGroupAnnouncementRequest) (*relationgrpcv1.GetGroupAnnouncementResponse, error) {
...
func (s *Service) UpdateGroupAnnouncement(ctx context.Context, in *relationgrpcv1.UpdateGroupAnnouncementRequest) (*relationgrpcv1.UpdateGroupAnnouncementResponse, error) {
...
func (s *Service) DeleteGroupAnnouncement(ctx context.Context, in *relationgrpcv1.DeleteGroupAnnouncementRequest) (*relationgrpcv1.DeleteGroupAnnouncementResponse, error) {

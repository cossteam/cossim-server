...
func init() {
	...
	//flag.StringVar(&metricsAddr, "metrics-bind-address", ":11004", "The address the metric endpoint binds to")
	//flag.StringVar(&httpProbeAddr, "http-health-probe-bind-address", ":11005", "The address to bind the http health probe endpoint")
	//flag.StringVar(&grpcProbeAddr, "grpc-health-probe-bind-address", ":11006", "The address to bind the grpc health probe endpoint")
	flag.Parse()
}

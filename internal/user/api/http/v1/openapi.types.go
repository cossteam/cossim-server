...
const (
	QRCodeStatusResponseStatusN0 QRCodeStatusResponseStatus = 0
	QRCodeStatusResponseStatusN1 QRCodeStatusResponseStatus = 1
	QRCodeStatusResponseStatusN2 QRCodeStatusResponseStatus = 2
	QRCodeStatusResponseStatusN3 QRCodeStatusResponseStatus = 3
)

// Defines values for UserInfoStatus.
const (
	UserInfoStatusN0 UserInfoStatus = 0
	UserInfoStatusN1 UserInfoStatus = 1
	UserInfoStatusN2 UserInfoStatus = 2
	UserInfoStatusN3 UserInfoStatus = 3
	UserInfoStatusN4 UserInfoStatus = 4
)
...
type QRCodeStatusResponseStatus int

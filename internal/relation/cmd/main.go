...
import (
	...
	"github.com/cossim/coss-server/internal/relation/interface/grpc"
	"github.com/cossim/coss-server/internal/relation/interface/http"
...
func init() {
	...
	//flag.StringVar(&httpProbeAddr, "http-health-probe-bind-address", ":9094", "The address to bind the http health probe endpoint")
	//flag.StringVar(&grpcProbeAddr, "grpc-health-probe-bind-address", ":9095", "The address to bind the grpc health probe endpoint")
	flag.Parse()
}

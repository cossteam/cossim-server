...
func (s *Handler) AddFriend(ctx context.Context, request *v1.AddFriendRequest) (*v1.AddFriendResponse, error) {
...
func (s *Handler) ManageFriendRevert(ctx context.Context, request *v1.ManageFriendRequest) (*v1.ManageFriendResponse, error) {
...
func (s *Handler) DeleteFriend(ctx context.Context, request *v1.DeleteFriendRequest) (*v1.DeleteFriendResponse, error) {
...
func (s *Handler) DeleteFriendRevert(ctx context.Context, request *v1.DeleteFriendRequest) (*v1.DeleteFriendResponse, error) {
...
func (s *Handler) AddBlacklist(ctx context.Context, request *v1.AddBlacklistRequest) (*v1.AddBlacklistResponse, error) {
...
func (s *Handler) DeleteBlacklist(ctx context.Context, request *v1.DeleteBlacklistRequest) (*v1.DeleteBlacklistResponse, error) {
...
func (s *Handler) GetFriendList(ctx context.Context, request *v1.GetFriendListRequest) (*v1.GetFriendListResponse, error) {
...
func (s *Handler) GetBlacklist(ctx context.Context, request *v1.GetBlacklistRequest) (*v1.GetBlacklistResponse, error) {
...
func (s *Handler) GetUserRelation(ctx context.Context, request *v1.GetUserRelationRequest) (*v1.GetUserRelationResponse, error) {
...
func (s *Handler) GetUserRelationByUserIds(ctx context.Context, request *v1.GetUserRelationByUserIdsRequest) (*v1.GetUserRelationByUserIdsResponse, error) {
...
func (s *Handler) SetFriendSilentNotification(ctx context.Context, request *v1.SetFriendSilentNotificationRequest) (*emptypb.Empty, error) {
...
func (s *Handler) SetUserOpenBurnAfterReading(ctx context.Context, in *v1.SetUserOpenBurnAfterReadingRequest) (*emptypb.Empty, error) {
	var resp = &emptypb.Empty{}
...
func (s *Handler) SetFriendRemark(ctx context.Context, in *v1.SetFriendRemarkRequest) (*emptypb.Empty, error) {
	var resp = &emptypb.Empty{}
...
func (s *Handler) SetUserOpenBurnAfterReadingTimeOut(ctx context.Context, request *v1.SetUserOpenBurnAfterReadingTimeOutRequest) (*emptypb.Empty, error) {
	resp := &emptypb.Empty{}
